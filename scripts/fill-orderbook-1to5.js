...
// fill-orderbook-1to5.js - Fill Order Book with $1 to $5 Prices
//
// 🎯 PURPOSE:
//   Fill the order book with liquidity at prices ranging from $1 to $5
//   Uses appropriate order sizes and handles margin requirements correctly
//
// 💰 PRICING STRATEGY:
//   - Buy prices: $1.00 to $4.50 (below $5)
//   - Sell prices: $1.50 to $5.00 (above $1)
//   - Order sizes: 0.1 to 2.0 ALU (realistic sizes)
//   - Mark price: $1.00 (current)
//
// 🚀 USAGE:
//   npx hardhat run scripts/fill-orderbook-1to5.js --network localhost
...
async function fillOrderBook1To5() {
  console.log(
    colorText(
      "\n💧 FILLING ORDER BOOK WITH $1 TO $5 PRICES",
      colors.brightYellow
    )
  );
...
// Run the script
fillOrderBook1To5().catch(console.error);
